...
from lmnet.networks.classification.vgg7 import Vgg7Quantize
...
from lmnet.quantizations.ternary import (
...
step_per_epoch = int(50000 / 100)
NETWORK.LEARNING_RATE_KWARGS = {
    "values": [0.1, 0.01, 0.001],
    "boundaries": [step_per_epoch * 80, step_per_epoch * 120],
}
