...
from lmnet.networks.object_detection.lm_fyolo import LMFYoloV2_2Quantize
...
NETWORK_CLASS = LMFYoloV2_2Quantize
...
for i in range(warmup_epochs, MAX_EPOCHS):
    values.append(max_lr * (1 - float(i-warmup_epochs) / MAX_EPOCHS) + last_lr)
    boundaries.append(step_per_epoch * i)
